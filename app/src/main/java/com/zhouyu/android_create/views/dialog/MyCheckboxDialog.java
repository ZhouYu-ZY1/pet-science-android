package com.zhouyu.android_create.views.dialog;
...
public class MyCheckboxDialog extends Dialog {
    ...
    public MyCheckboxDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_checkbox_dialog);
